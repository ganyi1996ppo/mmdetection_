...
train_pipeline = [
    dict(type='LoadImageFromFile_mixup'),
    dict(type='LoadAnnotations_mixup', with_bbox=True),
    dict(type='MixUp', alpha=1.0, beta=1.0),
    # dict(
    #     type='InstaBoost',
    ...
    #     hflag=False,
    #     aug_ratio=0.5),
    dict(type='Resize', img_scale=[(1333,600), (1333,800)], keep_ratio=True),

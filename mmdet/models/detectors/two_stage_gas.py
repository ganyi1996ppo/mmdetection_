...
class TwoStageDetector_gas(BaseDetector, RPNTestMixin, BBoxTestMixin,
                       MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStageDetector_gas, self).__init__()
        ...
        self.gas = False
        if gas_neck is not None:
            self.gas_neck = builder.build_neck(gas_neck)
            self.gas = True
    ...
    def init_weights(self, pretrained=None):
        super(TwoStageDetector_gas, self).init_weights(pretrained)
    ...
    def supervise_first(self,
        ...
        # the output size of proposals is [n, 5] the last one is the proposal score
